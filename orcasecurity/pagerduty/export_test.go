...
func buildPayload(ctx context.Context, st cc.State, diags *diag.Diagnostics) api_client.PagerDutyExternalServiceConfig {
	return testutils.SpecFromResource[api_client.PagerDutyExternalServiceConfig](NewPagerDutyResource()).BuildPayload(ctx, st, diags)
}

func extract(o *api_client.PagerDutyExternalServiceConfig, st cc.State, diags *diag.Diagnostics) cc.APIObject {
	return testutils.SpecFromResource[api_client.PagerDutyExternalServiceConfig](NewPagerDutyResource()).Extract(o, st, diags)
}
